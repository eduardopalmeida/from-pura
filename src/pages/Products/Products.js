...
const Products = () => {
    ...
    return ( 
        <main className="bg-gray-50 mb-auto">
            ...
            <div className="max-w-2xl mx-auto my-32 px-4 sm:my-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:my-16">

                <h2 id="#shampoos-solidos" className="text-2xl font-extrabold tracking-tight text-gray-900">Shampoos Sólidos</h2>
            ...
            <div className="max-w-2xl mx-auto my-16 px-4 py-8 sm:my-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:my-8">
                <h2 id="#amaciadores-solidos" className="text-2xl font-extrabold tracking-tight text-gray-900">Amaciadores Sólidos</h2>
